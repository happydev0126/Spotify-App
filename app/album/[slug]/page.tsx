    ...
    <div className="overflow-y-scroll overflow-x-hidden gap-6 flex flex-col">
      <div className="flex flex-col items-center md:flex-row md:items-end w-full gap-4">
        {album.images.length > 0 ?
          <img className="shadow xs:order-2 w-56 h-56 rounded" src={album.images[0].url} alt={album.name} /> :
          <div className="w-40 h-40 flex items-center justify-center bg-zinc-800 rounded">
            <svg
              ...
              className="w-12 h-12"
            >
              <path d="M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18zM1 12C1 5.925 5.925 1 12 1s11 4.925 11 11-4.925 11-11 11S1 18.075 1 12z"></path><path d="M12 10a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-4 2a4 4 0 1 1 8 0 4 4 0 0 1-8 0z"></path></svg>
          </div>
        }
