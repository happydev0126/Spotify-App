    ...
    >
      ...
      <div className="flex flex-row items-center gap-2">
        ...
        <div className="overflow-hidden">
          <div className={`${isCurrentlyPlaying(item.id, item.name) ? ' text-green ' : ' text-white '}text-white whitespace-nowrap text-ellipsis overflow-hidden text-md font-bold`}>{item.name}</div>
